 ...
 * @author franq
 */
public class TransferStudent extends javax.swing.JFrame {

    /**
     * Creates new form TransferStudent
     */
    ...
    public TransferStudent(int userid,int id,String surname,String fname,String lname) {
        /**/
        ...
        try {
            ...
            Logger.getLogger(TransferStudent.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void initComponents() {
        ...
        jbtsave.setText("Transfer");
        jbtsave.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jbtsaveActionPerformed(evt);
            }
        });
        jPanel2.add(jbtsave, new org.netbeans.lib.awtextra.AbsoluteConstraints(720, 330, -1, -1));
        ...
        jPanel2.add(btnok, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 330, -1, -1));
        ...
        jPanel2.add(jbtcancel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 330, -1, -1));
    ...
    private void jbtsaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtsaveActionPerformed
       ...
       surname = tfsurname.getText().toUpperCase();
       ...
       else
       {
         ...
         try {
            ...
            sqlupdates.updateStudentTransfer.updateTransferStudent(studentNumber);
             JOptionPane.showMessageDialog(null,
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TransferStudent.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TransferStudent(currentuserid,searchid,searchsurname,searchfname,searchlname).setVisible(true);
            }
        });
    }
