 ...
 * @author franq
 */
public class SearchTransferStudent extends javax.swing.JFrame {
    ...
    public SearchTransferStudent(int userid) {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SearchTransferStudent.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new SearchTransferStudent(currentuserid).setVisible(true);
            }
        });
    }
