 ...
 * @author franq
 */
public class SearchViewStudentBalance extends javax.swing.JFrame {
    ...
    public SearchViewStudentBalance(int userid) {
        initComponents();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if(jrbnumber.isSelected() == true)
        {
            ...
            ViewStudentBalance edit = new ViewStudentBalance(currentuserid, Integer.parseInt(this.tfstudentnumber.getText()), null, null, null);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SearchViewStudentBalance.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new SearchViewStudentBalance(currentuserid).setVisible(true);
            }
        });
    }
