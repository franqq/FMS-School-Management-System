...
public class ViewSubject extends javax.swing.JFrame {
     ...
     private static void updateTable()
    {
            ...
            ResultSet rs;
            String Sql= "SELECT `ID`, `Subject`, `description` FROM `subject` WHERE `departmentID`=?";
    ...
    private void btnprint1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnprint1ActionPerformed
        ...
        try {
            ...
            JasperDesign jd = JRXmlLoader.load("report\\deptsubjects.jrxml");
            
            String sql = "SELECT `ID`, `Subject`, `description` FROM `subject` WHERE `departmentID`="+ deptid + ";";
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewSubject(deptid).setVisible(true);
            }
        });
    }
