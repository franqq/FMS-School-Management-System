...
public class ViewGrading extends javax.swing.JFrame {
    ...
    private void btnprint1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnprint1ActionPerformed
        ...
        try {
            ...
            JasperDesign jd = JRXmlLoader.load("report\\deptgrades.jrxml");
            int subjectid = sqlinserts.NewSubject.getSubjectIDwithDeptID(deptid);
            String sql = "SELECT  `Grade`,`Low`, `High`,  `Remarks` FROM `subject_grade` WHERE  `subjectID`="+subjectid+";";
            ...
            Logger.getLogger(ViewGrading.class.getName()).log(Level.SEVERE, null, ex);
        } catch (SQLException ex) {
            Logger.getLogger(ViewGrading.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewGrading(deptid).setVisible(true);
            }
        });
    }
