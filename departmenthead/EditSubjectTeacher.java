 ...
 * @author franq
 */
public class EditSubjectTeacher extends javax.swing.JFrame {
    ...
    public EditSubjectTeacher(int deptid) {
        departmentid = deptid;
        initComponents();
       ...
       String classname,teachername,tn,cls,subjectname,subj;
        ...
        else if("SELECT MEMBER OF STAFF".equals(teachername))
        {
           ...
           try {
               ...
               sqlupdates.SubjectDetails.subjectTeacher(subjectid, staffid, classid);
               JOptionPane.showMessageDialog(null, "Subject Teacher Updated \n" +
                        "Press Ok to Continue", "Success ", JOptionPane.INFORMATION_MESSAGE);
               btnok.setEnabled(true);
               
           } catch (SQLException ex) {
               Logger.getLogger(EditSubjectTeacher.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditSubjectTeacher.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EditSubjectTeacher(departmentid).setVisible(true);
            }
        });
    }
