...
public class AddSubject extends javax.swing.JFrame {
    ...
    public AddSubject(int userid,int deptid) {
        initComponents();
        currentuserid = 3;
        currentdeptid = 2;
    }
    ...
    private void jbtsaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtsaveActionPerformed
        ...
        else
        {
            ...
            try {
                sqlinserts.NewSubject.createNewSubject(subjname, currentdeptid, description);
                NewSubjectGrade gradedetails = new NewSubjectGrade();
                gradedetails.main(new String[9]);
                this.dispose();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AddSubject(currentuserid,currentdeptid).setVisible(true);
            }
        });
    }
