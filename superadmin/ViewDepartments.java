...
public class ViewDepartments extends javax.swing.JFrame {
     ...
     private static void updateTable()
    {
            ...
            ResultSet rs;
            String Sql= "SELECT * FROM `department` WHERE 1";
    ...
    private void btnprint1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnprint1ActionPerformed
        ...
        try {
            ...
            JasperDesign jd = JRXmlLoader.load("report\\departments.jrxml");
            ...
            Logger.getLogger(ViewDepartments.class.getName()).log(Level.SEVERE, null, ex);
        }
