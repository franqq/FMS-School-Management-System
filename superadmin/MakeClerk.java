 ...
 * @author franq
 */
public class MakeClerk extends javax.swing.JFrame {
    ...
    public MakeClerk(int userid, int sid,String surnamec, String fnamec, String lnamec) {
        initComponents();
        ...
        try {
            ...
            Logger.getLogger(MakeClerk.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void initComponents() {
        ...
        jbtsave.setText("Register as Clerk");
    ...
    private void jbtsaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtsaveActionPerformed
        ...
        else if("".equals(jobtitle)||jobtitle == null)
        {
            ...
            try {
                ...
                sqlupdates.LoginInfo.updateLogin(nationalid, 3);
                JOptionPane.showMessageDialog(null, "User Successfully Promoted to a Clerk\n","Success", JOptionPane.INFORMATION_MESSAGE);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MakeClerk.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MakeClerk(currentuserid,Integer.parseInt(searchid),surnamel,fnamel,lnamel).setVisible(true);
            }
        });
    }
