 ...
 * @author franq
 */
public class EditStaffContacts extends javax.swing.JFrame {

    /**
     * Creates new form EditStaffContacts
     */
    private ArrayList<String> studentContactDetails;
    private static String contactID;
    
    public EditStaffContacts(String searchcontact) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel8.setText("Edit Staff Contacts");

        jLabel9.setForeground(new java.awt.Color(255, 0, 0));
        jLabel9.setText(" Stasff Details Saved");
    ...
    private void jbuttonsavecontactsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbuttonsavecontactsActionPerformed
        ...
        else if(strtown==null||"".equals(strtown) )
        {
            ...
            try {
                ...
                {
                sqlupdates.StaffInfo.updateStaffContacts(mob, stremail, add, strtown, Integer.parseInt(contactID));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditStaffContacts.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new EditStaffContacts(contactID).setVisible(true);
            }
        });
    }
