...
public class ViewStaff extends javax.swing.JFrame {
     ...
     private static void updateTable()
    {
            ...
            String Sql= "SELECT `nationalID` AS 'National ID', `Title`, `Surname`, "
                    + "`First Name`, `Job Title` FROM `staff` WHERE `Whether Working`=1 ORDER BY `nationalID` DESC";
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Members Of Staff");
    ...
    private void btnprint1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnprint1ActionPerformed
        ...
        try {
            ...
            JasperDesign jd = JRXmlLoader.load("report\\staff.jrxml");
