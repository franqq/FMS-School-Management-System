 ...
 * @author franq
 */
public class DismissSearchStaff extends javax.swing.JFrame {

    /**
     * Creates new form SearchStaff
     */
    private static int currentuserid;
    public DismissSearchStaff(int userid) {
        initComponents();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if(jrbnumber.isSelected() == true)
        {
            if("".equals(tfstudentnumber.getText()))
            {
                ...
                if(nationalid!=-1)
                {
                DismissStaff dismissStaff = new DismissStaff(currentuserid, nationalid, null, null, null);
                dismissStaff.main(new String[9]);
                this.hide();
                }
            }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DismissSearchStaff.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DismissSearchStaff(currentuserid).setVisible(true);
            }
        });
    }
