 ...
 * @author franq
 */
public class EditSupportStaffContacts extends javax.swing.JFrame {

    /**
     * Creates new form EditSupportStaffContacts
     */
     private ArrayList<String> studentContactDetails;
    private static String contactID;
    
    public EditSupportStaffContacts(String searchcontact) {
        initComponents();
        
         contactID = searchcontact;
        
        
        String mobileNo,emailAddress,physicalAddress,homeTown;
        
        studentContactDetails = selects.QuerySearchStaff.getStaffContact(contactID);
    ...
    private void initComponents() {
        ...
        tfpadd = new javax.swing.JFormattedTextField();
        ...
        try {
            tfpadd.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.MaskFormatter("#####")));
        } catch (java.text.ParseException ex) {
            ex.printStackTrace();
        }
        tfpadd.setVerifyInputWhenFocusTarget(false);
        tfpadd.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                tfpaddActionPerformed(evt);
            }
        });
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, staffcontactsLayout.createSequentialGroup()
                ...
                .addGroup(staffcontactsLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(staffcontactsLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        .addComponent(tftown)
                        .addComponent(tfpadd, javax.swing.GroupLayout.DEFAULT_SIZE, 200, Short.MAX_VALUE))
        ...
        jLabel8.setText("Edit Support Staff Contacts");

        jLabel9.setForeground(new java.awt.Color(255, 0, 0));
        jLabel9.setText("Details Saved");
    ...
    private void jbuttonsavecontactsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbuttonsavecontactsActionPerformed
        ...
        else if(strtown==null||"".equals(strtown) )
        {
            ...
            try {
                ...
                {
               sqlupdates.SupportStaffInfo.updateSupportStaffContacts(mob, stremail, add, strtown, Integer.parseInt(contactID));
                ...
                {
                    JOptionPane.showMessageDialog(null, "The Store Assistant Information   Has Already Been Saved Before. \n" +
    ...
    private void tfpaddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tfpaddActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_tfpaddActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditSupportStaffContacts.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EditSupportStaffContacts(contactID).setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JFormattedTextField tfpadd;
