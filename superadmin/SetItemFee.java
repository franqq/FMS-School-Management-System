 ...
 * @author franq
 */
public class SetItemFee extends javax.swing.JFrame {
    ...
    public SetItemFee(int info, String itemname) {
        saved = false;
        initComponents();
        borderinfo = info;
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Enter Fee Details");
        ...
        lblsaved.setText("Fee Category saved");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SetItemFee.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SetItemFee(borderinfo,tablename).setVisible(true);
            }
        });
    }
