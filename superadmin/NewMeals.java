 ...
 * @author franq
 */
public class NewMeals extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        String fordetails,classreq,fee;
        int clsid;
        ...
        else
        {
            ...
            try {
                sqlinserts.NewMeals.createNewMeals(termid,clsid,fordetails,Double.parseDouble(fee));
                ...
                {
                    JOptionPane.showMessageDialog(null, "The Meals Details You are Trying to Create Have Already Been Saved Before. \n" +
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NewMeals.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
