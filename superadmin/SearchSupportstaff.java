 ...
 * @author franq
 */
public class SearchSupportstaff extends javax.swing.JFrame {
    ...
    public SearchSupportstaff(int userid) {
        initComponents();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if(jrbnumber.isSelected() == true)
        {
            if("".equals(tfstudentnumber.getText()))
            {
                ...
                {
                EditSupportStaff edit = new EditSupportStaff(currentuserid, staffid, null, null, null);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SearchSupportstaff.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SearchSupportstaff(currentuserid).setVisible(true);
            }
        });
    }
