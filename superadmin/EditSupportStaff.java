 ...
 * @author franq
 */
public class EditSupportStaff extends javax.swing.JFrame {
    ...
    public EditSupportStaff(int userid, long sid,String surnamec, String fnamec, String lnamec) {
        initComponents();
    ...
    private void jbtsaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtsaveActionPerformed
        ...
        else if("".equals(jobtitle)||jobtitle == null)
        {
            ...
            try {
                ...
                sqlupdates.SupportStaffInfo.updateStaffInfo(nationalid, gender, title, surname, fname, lname, dob, 
                        jobtitle, role, whetherwkng, searchnationalid);

                JOptionPane.showMessageDialog(null, "Support Staff Details Successfylly Updated\n","Success", JOptionPane.INFORMATION_MESSAGE);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditSupportStaff.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EditSupportStaff(currentuserid,Long.parseLong(searchnationalid),surnamel,fnamel,lnamel).setVisible(true);
            }
        });
    }
