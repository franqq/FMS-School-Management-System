 ...
 * @author franq
 */
public class NewSupportStaffContact extends javax.swing.JFrame {

    /**
     * Creates new form NewSupportStaffContact
     */
    
    
    private static int currentuserid;
    
    public NewSupportStaffContact(int usrd) {
        initComponents();
        currentuserid = usrd;
    ...
    private void initComponents() {
        ...
        jLabel8.setText("Enter Support Staff Contacts");
    ...
    private void jbuttonsavecontactsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbuttonsavecontactsActionPerformed
        ...
        else if(strtown==null||"".equals(strtown) )
        {
            ...
            try {
                ...
                {
                sqlinserts.NewSupportStaff.support_staffContact(mob, stremail, add, strtown);
                NewSupportStaff newcontact = new NewSupportStaff(currentuserid);
                ...
                {
                    JOptionPane.showMessageDialog(null, "The Contact Information Has Already Been Saved Before. \n" +
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NewSupportStaffContact.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NewSupportStaffContact(currentuserid).setVisible(true);
            }
        });
    }
