 ...
 * @author franq
 */
public class DismissSearchSupportstaff extends javax.swing.JFrame {

    /**
     * Creates new form SearchSupportstaff
     */
    private static int currentuserid;
    
    public DismissSearchSupportstaff(int userid) {
        initComponents();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if(jrbnumber.isSelected() == true)
        {
            if("".equals(tfstudentnumber.getText()))
            {
                ...
                Long staffid=Long.parseLong("-1");
                try{
                staffid = Long.parseLong(this.tfstudentnumber.getText());
                }
                catch(Exception ex)
                {
                   JOptionPane.showMessageDialog(null,
                ...
                if(staffid!=Long.parseLong("-1"))
                {
                DismissSupportStaff dismissSupportStaff = new DismissSupportStaff(currentuserid, staffid, null, null, null);
                dismissSupportStaff.main(new String[9]);
                this.hide();
                }
            }
        }
        else if(jrbname.isSelected() == true)
        {
            ...
            else if("".equals(lname))
            {
                ...
                EditSupportStaff edit = new EditSupportStaff(currentuserid, 0, surname, fname, lname);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DismissSearchSupportstaff.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DismissSearchSupportstaff(currentuserid).setVisible(true);
            }
        });
    }
