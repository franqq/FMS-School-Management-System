 ...
 * @author franq
 */
public class NewFeePaymentNonBorder {
    private static DBConnection dbconn;
    
    public static void payNonBorderFee(Long studentid, double ammount, String paymentfor,int clerkid) throws SQLException
    {
        NewReceiptNo receiptupdate = new NewReceiptNo(true);
        PreparedStatement stmt = null;
        dbconn = new DBConnection();
        Connection conn = dbconn.vconnection;
        String insert = "INSERT INTO `fee_payment_non_borders`(`Receipt No`, `studentID`,`Ammount`, `Payment For`, `Date`, `clerkID`)"
                + "VALUES(?,?,?,?,?,?)";
