 ...
 * @author franq
 */
public class QuerySearchSupportStaff {
     public static ArrayList getSupportStaffInfo(String nationalid)
    {
            ...
            String Sql = "SELECT `Gender`,`DOB`,`nationalID`, `Title`, `Surname`, `First Name`,"
                    + " `Last Name`, `Job Title`, `Role`, `Whether Working`,`ID`,`ContactID` FROM `support_staff` WHERE `nationalID`=?";
          try {            
             ...
             if(rs.first() == true)
             {
                 rs.previous();
                  ...
                  srddetails.add(rs.getString("ContactID"));
                      ...
                      "The Suppott Staff Details Were not Found\n"+
       ...
       return srddetails;
         ...
         public static ArrayList getSupportStaffInfo(String surname,String fname, String lname)
    {
            DBConnection dbconn =new DBConnection();
            Connection conn = dbconn.vconnection;
            PreparedStatement pstmt;
            ...
            ArrayList srddetails = new ArrayList<String>();
            String Sql = "SELECT `Gender`,`DOB`,`nationalID`, `Title`, `Surname`, `First Name`,"
                    + " `Last Name`, `Job Title`, `Role`, `Whether Working`,`ID` FROM `support_staff` WHERE `Surname`=? AND `First Name`=? AND `Last Name`=?";
          try {            
            pstmt = conn.prepareStatement(Sql);
    ...
    public static ArrayList getSupportStaffContact(String contactId)
    {
            DBConnection dbconn =new DBConnection();
            Connection conn = dbconn.vconnection;
            PreparedStatement pstmt;
