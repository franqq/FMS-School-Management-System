 ...
 * @author franq
 */
public class SuperUserContacts extends javax.swing.JFrame {
    ...
    public SuperUserContacts(int userid) {
        initComponents();
    ...
    private void initComponents() {
        ...
        staffcontactsLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, staffcontactsLayout.createSequentialGroup()
                ...
                .addGroup(staffcontactsLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(tfpadd, javax.swing.GroupLayout.PREFERRED_SIZE, 200, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(35, 35, 35))
        );
        ...
        jLabel8.setText("Enter Main Admins Contacts");
    ...
    private void jbuttonsavecontactsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbuttonsavecontactsActionPerformed
        ...
        else if(strtown==null||"".equals(strtown) )
        {
            ...
            try {
                ...
                {
                sqlinserts.NewStaff.staffContact2(strmob, stremail, add, strtown);
                SuperUserDetails newcontact = new SuperUserDetails(currentuserid);
                newcontact.main(new String[9]);
                this.hide();
                }

            } catch (SQLException ex) {
                Logger.getLogger(SuperUserContacts.class.getName()).log(Level.SEVERE, null, ex);

                if(ex.getErrorCode() == 1062)
                {
                    JOptionPane.showMessageDialog(null, "The User Information  Has Already Been Saved Before. \n" +
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SuperUserContacts.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new SuperUserContacts(currentuserid).setVisible(true);
            }
        });
    }
