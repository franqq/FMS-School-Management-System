 ...
 * @author franq
 */
public class SuperUserDetails extends javax.swing.JFrame {
    ...
    public SuperUserDetails(int userid) {
        initComponents();
    ...
    private void jbtsaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtsaveActionPerformed
        // TODO add your handling code here:
        String gender,title,surname,fname,lname,dob,jobtitle,role;
        ...
        else if("".equals(jobtitle)||jobtitle == null)
        {
            ...
            try {
                ...
                JOptionPane.showMessageDialog(null, "Details Successfylly Saved\n","Success", JOptionPane.INFORMATION_MESSAGE);
                this.lblsaved.setText("Details Saved");
            }
            catch (SQLException ex) {
                Logger.getLogger(SuperUserDetails.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void jbtcancel2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtcancel2ActionPerformed
        ...
        {
            SetPassWord setpass = new SetPassWord(nationalid);
            setpass.main(new String[9]);
            this.hide();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SuperUserDetails.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new SuperUserDetails(currentuserid).setVisible(true);
            }
        });
